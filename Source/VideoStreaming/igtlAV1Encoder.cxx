...
//static const VpxInterfaceEncoder AV1StaticEncoder[] = {{&vpx_codec_AV1_cx}};
//
//void igtlAV1Encoder::error_output(vpx_codec_ctx_t *ctx, const char *s) {
...
//int igtlAV1Encoder::vpx_img_plane_width(const vpx_image_t *img, int plane) {
...
//}
//
//int igtlAV1Encoder::vpx_img_plane_height(const vpx_image_t *img, int plane) {
...
int igtlAV1Encoder::SetLosslessLink(bool linkMethod)
{
  ...
  //if (vpx_codec_control_(codec, AV1E_SET_LOSSLESS, linkMethod))
  //  {
...
int igtlAV1Encoder::InitializeEncoder()
{
  ...
  //  }
  //
  //if (vpx_codec_control_(codec, AV1E_SET_LOSSLESS, this->GetLosslessLink()))
  //  {
  //  error_output(codec, "Failed to set lossless mode");
  //  return -1;
  //  }
